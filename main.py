...
def start_screen():
    ...
    while waiting:
        ...
        start_text = font_small.render("Press ENTER to Start", True, (255, 255, 0))
        screen.blit(title, (200, 220))
        screen.blit(start_text, (240, 320))
